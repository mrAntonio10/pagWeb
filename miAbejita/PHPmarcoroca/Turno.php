...
<body background="imagenes/abejitape.jpg">
 ...
 <?php
  ...
  $consulta = "select * from turno;";
   ...
   echo "<td> TURNO</td>";
     echo "<td>  HORARIO_INGRESO</td>";
	      echo "<td> HORARIO_SALIDA </td>";
	...
	echo"<tr>";
      ...
      echo "<td bgcolor=\"#CCCCCC\" align=\"center\">$fila->turno</td>";
	       echo "<td bgcolor=\"#CCCCCC\"  align=\"center\">$fila->horario_ingreso</td>";
		   echo "<td bgcolor=\"#CCCCCC\"  align=\"center\">$fila->horario_salida</td>";
